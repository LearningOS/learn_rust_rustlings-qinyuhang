...
impl FromStr for Climate {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        let (city, year, temp) = match &v[..] {
            [city, year, temp] if *city != "" => (city.to_string(), year, temp),
            [city, _, _] if *city == "" => return Err(ParseClimateError::NoCity),
            [city, _] if *city == "" => return Err(ParseClimateError::NoCity),
            [city] if *city == "" => return Err(ParseClimateError::Empty),
